...
> **Setup guides:**
> - [Local Setup](LOCAL_SETUP.md) — get the full stack running locally
...
1. **Get API Keys** — see [LOCAL_SETUP.md](LOCAL_SETUP.md#1-get-api-keys)
2. **Start Elasticsearch** — see [LOCAL_SETUP.md](LOCAL_SETUP.md#2-start-elasticsearch)
3. **Ingest data** — run `ingestion.py`, `ingest_deadlines.py`, and `ingest_usnews_rankings.py` per [LOCAL_SETUP.md](LOCAL_SETUP.md#3-ingest-data-into-elasticsearch)
4. **Start Open WebUI** — see [LOCAL_SETUP.md](LOCAL_SETUP.md#4-start-open-webui-frontend--backend)
5. **Chat** — select a model (e.g. `gpt-4o-mini`) and ask about faculty, deadlines, or resume fit
